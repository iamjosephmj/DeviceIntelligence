...
constexpr size_t kJniEnvWatched = 11;
 ...
 *
 * NOTE: nothing calls this. On baseline tamper the vector silently recaptures and
 * reports no drift for that round, and the tamper itself is never surfaced. See
 * issue #8 (dead scaffolding).
 */
