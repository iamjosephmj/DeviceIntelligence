...
// `DICORE_VERIFY_CALLER()` — drop this as the first line of any JNI
...
#include "dicore/detectors/native_integrity/process/caller_verify.h"

#define DICORE_VERIFY_CALLER() \
